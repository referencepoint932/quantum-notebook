...
An educational Jupyter notebook series that teaches quantum computing concepts through progressive, hands-on lessons — from basic superposition to interference-based algorithms, quantum optimization, topological quantum computing, and quantum simulation.

All circuits run **locally** using [Qiskit 2.x](https://qiskit.org/) and `BasicSimulator` — no cloud accounts or hardware access required.
...
| 103 | `103_quantum_deutsch.ipynb` | Deutsch algorithm |
